...
/**
 * This is the item provider adapter for a {@link model.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.CONFIGURATION__MAPPINGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Configuration.class)) {
			case ModelPackage.CONFIGURATION__MAPPINGS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CONFIGURATION__MAPPINGS,
				 ModelFactory.eINSTANCE.createMapping()));
	}
