...
/**
 * This is the item provider adapter for a {@link orm.model.Fulfilment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FulfilmentItemProvider
	 ...
	 * @generated
	 */
	public FulfilmentItemProvider(AdapterFactory adapterFactory) {
	 ...
	 * @generated
	 */
	protected void addFufilledRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fulfilment_fufilledRole_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fulfilment_fufilledRole_feature", "_UI_Fulfilment_type"),
				 OrmPackage.Literals.FULFILMENT__FUFILLED_ROLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Fulfilment"));
	}
	...
	public String getText(Object object) {
		String label = ((Fulfilment)object).getFufilledRole();
		return label == null || label.length() == 0 ?
			getString("_UI_Fulfilment_type") :
			getString("_UI_Fulfilment_type") + " " + label;
	}
