 ...
 * </p>
 * <ul>
 *   <li>{@link editPolicyEcore1.impl.AndRuleImpl#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndRuleImpl extends AbstractRuleImpl implements AndRule {
	/**
	...
	protected EClass eStaticClass() {
		return EditPolicyEcore1Package.Literals.AND_RULE;
	}
	...
	public EList<AbstractRule> getRules() {
		if (rules == null) {
			rules = new EObjectContainmentEList<AbstractRule>(AbstractRule.class, this, EditPolicyEcore1Package.AND_RULE__RULES);
		}
		return rules;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EditPolicyEcore1Package.AND_RULE__RULES:
