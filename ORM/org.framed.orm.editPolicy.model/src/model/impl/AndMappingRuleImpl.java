 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.AndMappingRuleImpl#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndMappingRuleImpl extends AbstractMappingRuleImpl implements AndMappingRule {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.AND_MAPPING_RULE;
	}
	...
	public EList<AbstractMappingRule> getRules() {
		if (rules == null) {
			rules = new EObjectContainmentEList<AbstractMappingRule>(AbstractMappingRule.class, this, ModelPackage.AND_MAPPING_RULE__RULES);
		}
		return rules;
	}
