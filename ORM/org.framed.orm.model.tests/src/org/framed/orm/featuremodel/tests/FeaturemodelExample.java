/**
 */
package org.framed.orm.featuremodel.tests;
...
public class FeaturemodelExample {
  ...
  public static void main(String[] args) {
    ...
    resourceSet.getPackageRegistry()
        .put(FeaturemodelPackage.eNS_URI, FeaturemodelPackage.eINSTANCE);
    ...
    if (args.length == 0) {
      ...
      try {
        ...
        FRaMEDFeature root = FeaturemodelFactory.eINSTANCE.createFRaMEDFeature();
