 ...
 * <ul>
 *   <li>{@link orm.model.impl.RelationshipImpl#getRelationContainer <em>Relation Container</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getBendpoints <em>Bendpoints</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getSecondParthood <em>Second Parthood</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getSecondLower <em>Second Lower</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getFirstLower <em>First Lower</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getFirstUpper <em>First Upper</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getSecondUpper <em>Second Upper</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getFirstParthood <em>First Parthood</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getSourceLabelValue <em>Source Label Value</em>}</li>
 *   <li>{@link orm.model.impl.RelationshipImpl#getTargetLabelValue <em>Target Label Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
