...
public class ComplexConstraintImpl extends ConstraintImpl implements ComplexConstraint {
   ...
   * @ordered
   */
  protected EList<RoleGroup> groups;
  ...
  public EList<RoleGroup> getGroups() {
    if (groups == null) {
      groups = new EObjectResolvingEList<RoleGroup>(RoleGroup.class, this, OrmPackage.COMPLEX_CONSTRAINT__GROUPS);
    }
    return groups;
  }
  ...
  public void setExpression(String newExpression) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.COMPLEX_CONSTRAINT__EXPRESSION, oldExpression, expression));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case OrmPackage.COMPLEX_CONSTRAINT__GROUPS:
        return getGroups();
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      case OrmPackage.COMPLEX_CONSTRAINT__GROUPS:
        getGroups().clear();
        getGroups().addAll((Collection<? extends RoleGroup>)newValue);
        return;
      case OrmPackage.COMPLEX_CONSTRAINT__EXPRESSION:
