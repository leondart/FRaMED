...
public class OrmPackageImpl extends EPackageImpl implements OrmPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getModel_Parent(), this.getShape(),
				...
				IS_ORDERED);
		initEReference(getModel_Config(),
				theFeaturemodelPackage.getConfiguration(), null, "config",
		...
		initEReference(getRelation_ReferencedRoles(), this.getShape(), null,
				...
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelation_ConnectionAnchor(), this.getShape(), null,
				"connectionAnchor", null, 0, 1, Relation.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
