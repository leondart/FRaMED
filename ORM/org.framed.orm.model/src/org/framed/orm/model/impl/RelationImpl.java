...
public class RelationImpl extends ModelElementImpl implements Relation {
	...
	public EList<Shape> getReferencedRoles() {
		return (EList<Shape>) eGet(
				OrmPackage.Literals.RELATION__REFERENCED_ROLES, true);
	}
	...
	public Shape getConnectionAnchor() {
		return (Shape) eGet(OrmPackage.Literals.RELATION__CONNECTION_ANCHOR,
				true);
	}
	...
	public void setConnectionAnchor(Shape newConnectionAnchor) {
		eSet(OrmPackage.Literals.RELATION__CONNECTION_ANCHOR,
				newConnectionAnchor);
	}
