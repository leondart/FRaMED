...
public interface ModelElement extends NamedElement {
   ...
   * and its opposite is '{@link org.framed.orm.model.Model#getElements <em>Elements</em>}'. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Container</em>' container reference isn't clear, there really should
