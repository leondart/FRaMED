...
public final class Util {
   ...
   * 
   * @param iterable {@link Iterable} of arbitrary elements
   * @param delimiter the separator between each element
   * @return the concatenation of the strings obtained from each element of the {@link Iterable}
  ...
  public static final String join(final String delimiter, final Iterable<?> iterable) {
    ...
    if (i == null)
      throw new IllegalArgumentException("The iterator provided was null!");
    if (i.hasNext())
