...
public enum Type implements Enumerator {
	 ...
	 * @ordered
	 */
	RELATIONSHIP_SHAPE_CHILD(16, "RelationshipShapeChild",
			"RelationshipShapeChild"),
	...
	private static final Type[] VALUES_ARRAY = new Type[] { COMPARTMENT_TYPE,
			...
			RELATIONSHIP_IMPLICATION, RELATIONSHIP_SHAPE_CHILD, ACYCLIC,
			REFLEXIVE, RELATIONSHIP_EXCLUSION, };
