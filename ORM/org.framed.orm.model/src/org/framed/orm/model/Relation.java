...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Relation</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface Relation extends ModelElement {
   ...
   * opposite is '{@link org.framed.orm.model.ModelElement#getIncomingRelations
   * <em>Incoming Relations</em>}'. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.framed.orm.model.Relation#getTarget <em>Target</em>}'
   ...
   * opposite is '{@link org.framed.orm.model.ModelElement#getOutgoingRelations
   * <em>Outgoing Relations</em>}'. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.framed.orm.model.Relation#getSource <em>Source</em>}'
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Bendpoints</b></em>' containment reference list. The list
   * contents are of type {@link org.framed.orm.geometry.RelativePoint}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Bendpoints</em>' containment reference list isn't clear, there
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Source Label</em>' containment reference isn't clear, there really
  ...
  /**
   * Sets the value of the '{@link org.framed.orm.model.Relation#getSourceLabel
   * <em>Source Label</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Target Label</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.framed.orm.model.Relation#getTargetLabel
   * <em>Target Label</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Referenced Relation</b></em>' reference list. The list
   * contents are of type {@link org.framed.orm.model.Relation}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Referenced Relation</em>' reference isn't clear, there really should
  ...
  /**
   * Returns the value of the '<em><b>Referenced Roles</b></em>' reference list. The list contents
   * are of type {@link org.framed.orm.model.Shape}. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Referenced Roles</em>' reference list isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Connection Anchor</b></em>' reference. <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Connection Anchor</em>' reference isn't clear, there really should
   * be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Sets the value of the '{@link org.framed.orm.model.Relation#getConnectionAnchor
   * <em>Connection Anchor</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
