...
public interface Shape extends ModelElement {
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>First Segment</em>' containment reference isn't clear, there really
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Second Segment</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the value of the '<em><b>Model</b></em>' containment reference. It is bidirectional and
   * its opposite is '{@link org.framed.orm.model.Model#getParent <em>Parent</em>}'. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Model</em>' containment reference isn't clear, there really should
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Description</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Boundaries</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
