...
public interface OrmPackage extends EPackage {
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.framed.orm.model.Model#getFramedConfiguration <em>Framed Configuration</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Framed Configuration</em>'.
   * @see org.framed.orm.model.Model#getFramedConfiguration()
   * @see #getModel()
   * @generated
   */
