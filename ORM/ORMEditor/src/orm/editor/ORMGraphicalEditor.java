...
public class ORMGraphicalEditor extends GraphicalEditorWithFlyoutPalette {
	...
	@Override protected void configureGraphicalViewer() {
		    ...
		    getGraphicalViewer().setContextMenu(new ORMGraphicalEditorContextMenuProvider(getGraphicalViewer(), getActionRegistry()));
      ...
      if(type.equals(IPropertySheetPage.class)) {
          if(propertyPage == null) {
              ...
              IPropertySourceProvider sourceProvider = new IPropertySourceProvider() {
                  IPropertySourceProvider modelPropertySourceProvider = new AdapterFactoryContentProvider(new OrmItemProviderAdapterFactory());
