...
public class ORMShapeChangeBoundariesCommandTest {

  @Test
  public void testCanExecute() {
    ORMShapeChangeBoundariesCommand obj = new ORMShapeChangeBoundariesCommand();
    ...
    obj.setNewBoundaries(new Rectangle() {
