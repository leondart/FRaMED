...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Case</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface TestCase extends EObject {
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Framed Model</em>' containment reference isn't clear, there really
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Crom Model</em>' containment reference isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
