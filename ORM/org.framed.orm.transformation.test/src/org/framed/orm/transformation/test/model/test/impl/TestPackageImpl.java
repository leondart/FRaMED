...
public class TestPackageImpl extends EPackageImpl implements TestPackage {
	...
	public void initializePackageContents() {
		...
		Crom_l1_composedPackage theCrom_l1_composedPackage = (Crom_l1_composedPackage)EPackage.Registry.INSTANCE.getEPackage(Crom_l1_composedPackage.eNS_URI);
		...
		initEAttribute(getTestCase_Title(), ecorePackage.getEString(), "title", null, 0, 1, TestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTestCase_FramedModel(), theOrmPackage.getModel(), null, "framedModel", null, 0, 1, TestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTestCase_CromModel(), theCrom_l1_composedPackage.getModel(), null, "cromModel", null, 0, 1, TestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
