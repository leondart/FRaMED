...
public class ORMCompartmentEditPart extends ORMShapeWithSegmentEditPart {
  ...
  /**
   * {@inheritDoc} The refreshVisuals of this {@link EditPart} the names of all roleTypes
   * and roleGroups in the child {@link Model} are added to the rolePart and the method
   ...
   * {@link Model}. If the figure of the {@link Model} or the rolePart is added to this
   * compartment depends on which version of the compartment figure is used also if the user
   * has steped into thr compartment or not. ( the adding of segment figures is handelt
   * through calling {@link ORMShapeWithSegmentEditPart#addChildVisual(EditPart, index)}.
   */
  @Override
