...
//      ORMGroupingV1Figure figure1 = new ORMGroupingV1Figure();
//      return figure1;
//    }
...
//
//        label.setText((new ORMLabelFigure()).shortenLabel(labelText, label.getBounds(),
//            label.getFont(), ((Grouping) getModel()).getConstraints()));
...
//      return type.getClass().equals(Grouping.class);
//    }
//  }
//=======
public class ORMGroupingEditPart extends AbstractGraphicalEditPart implements NodeEditPart{
	 ...
	 * we can make the MainContext unselectable for Conectioncreation
	 * 
	 * */
	...
	public void refreshVisuals() {
		if(figure instanceof ORMGroupingV1Figure){
		 ...
		 //TODO: implement something better for synchronsation 
		// shows all compartment names, which are in the child rolemodel(this will change in later version of the model) of this grouping
