...
/**
 * This figure is for {@link Shape}s from type RoleGroup. The figure looks in the viewer/editor
 * somewhat like this:
 * 
 * -------Cardinality--------- | Name | | | | Child Model | | | ---------------------------
 * 
 * The corners of the rectangle are round and the border lines of the rectangle are dashed. The
 * Child {@link Model} figure is added in the editparts.
 * 
...
public class ORMRoleGroupFigure extends ORMShapeFigure {
  ...
  /**
   * The basic {@link RoundedRectangle} to which all child figures({@link ORMRootModelFigure} ,
   * name) are added.
   */
   ...
   * called, the basic {@link RoundedRectangle} is initialized and the child figure for the name(
