 ...
 * @since 3.0
 */
public class ORMFlyoutPaletteComposite extends Composite {
    ...
    private ORMFlyoutPreferences prefs;
     ...
     * @param flyoutPreferences
     *            To save/retrieve the preferences for the flyout
     */
    public ORMFlyoutPaletteComposite(Composite parent, int style,
            IWorkbenchPage page, ORMPaletteViewerProvider pvProvider,
            ORMFlyoutPreferences flyoutPreferences) {
        super(parent, style | SWT.NO_BACKGROUND | SWT.NO_REDRAW_RESIZE
                | SWT.DOUBLE_BUFFERED);
        provider = pvProvider;
        prefs = flyoutPreferences;
        sash = createSash();
     ...
     * @since 3.2
     */
    public static ORMFlyoutPreferences createFlyoutPreferences(Preferences prefs) {
        return (ORMFlyoutPreferences) new DefaultFlyoutPreferences(prefs);
    }
     ...
     * @since 3.0
     */
    public interface ORMFlyoutPreferences {
        /**
         ...
         * collapsed), or {@link ORMFlyoutPaletteComposite#STATE_COLLAPSED}, or
         * {@link ORMFlyoutPaletteComposite#STATE_PINNED_OPEN}
         * 
         ...
         * 
         * @param state
         *            {@link ORMFlyoutPaletteComposite#STATE_COLLAPSED} or
         *            {@link ORMFlyoutPaletteComposite#STATE_PINNED_OPEN}
         */
    ...
    private class ResizeAction extends Action {
        ...
        public void run() {
            final Tracker tracker = new Tracker(ORMFlyoutPaletteComposite.this,
                    SWT.RIGHT | SWT.LEFT);
    ...
    private class TitleDragManager extends MouseAdapter implements Listener,
        ...
        public void handleEvent(Event event) {
            ...
            threshold = dock == PositionConstants.EAST ? Integer.MAX_VALUE / 2
                    : -1;
            final Composite flyout = ORMFlyoutPaletteComposite.this;
                        ...
                        public void run() {
                            ...
                            if (!switchDock)
                                invalid = !isDescendantOf(
                                        ORMFlyoutPaletteComposite.this, ctrl);
                            if (switchDock) {
                                if (dock == PositionConstants.WEST) {
    ...
    private class TitleCanvas extends Canvas {
        ...
        public void setFont(Font font) {
            ...
            if (isVisible()) {
                 ...
                 * getParent().layout().
                 */
                ORMFlyoutPaletteComposite.this.layout(true);
     ...
     * @since 3.2
     */
    private static class DefaultFlyoutPreferences implements ORMFlyoutPreferences {
        /*
