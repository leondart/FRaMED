...
public enum PaletteEntry {
  ...
  ROLE_TYPE("RoleType"), ROLE_GROUP("RoleGroup"), ROLE_IMPLICATION("Role Implication"), RELATIONSHIP_IMPLICATION(
      "Relationship Implication"), RELATIONSHIP_EXCLUSION("Relationship Exclusion"), ROLE_EQUIVALENCE(
