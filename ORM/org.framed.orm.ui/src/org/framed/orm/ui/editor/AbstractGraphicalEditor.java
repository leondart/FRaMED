...
/**
 * 
 * This class have to be inherited by the ORMGraphicalEditor. It provides standard editor functions
 * and uses a palette with a global enabeld vertical scrollbar. This is needed to avoid a bug of the
 * standard scroll bar, which does not allow the user to scroll to the last palette item.
 * 
 * @author Paul Peschel
 * 
 */
public abstract class AbstractGraphicalEditor extends GraphicalEditor {
  ...
  protected FlyoutPreferences getPalettePreferences() {
    return FlyoutPaletteComposite.createFlyoutPreferences(InternalGEFPlugin.getDefault()
   ...
   * (one displayed in the editor and the other displayed in the PaletteView) in sync when switching
   * from one to the other (i.e., it helps maintain state across the two viewers).
   * 
   * @author Pratik Shah
   * @since 3.0
   */
  protected class CustomPalettePage extends PaletteViewerPage {
     ...
     * Constructor
     * 
     * @param ormPaletteViewerProvider the provider used to create a PaletteViewer
     */
