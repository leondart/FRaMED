...
public class OrmItemProviderAdapterFactory extends OrmAdapterFactory implements
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.framed.orm.model.NamedElement}
  ...
  /**
   * This creates an adapter for a {@link org.framed.orm.model.NamedElement}. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.framed.orm.model.ModelElement}
   * instances. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.framed.orm.model.ModelElement}. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.framed.orm.model.Model}. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.framed.orm.model.Relation}
   * instances. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.framed.orm.model.Relation}. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.framed.orm.model.Shape} instances.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.framed.orm.model.Shape}. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link org.framed.orm.model.Segment}
   * instances. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.framed.orm.model.Segment}. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @generated
   */
