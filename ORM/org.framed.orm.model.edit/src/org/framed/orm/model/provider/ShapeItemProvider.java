...
public class ShapeItemProvider extends ModelElementItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Shape"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				OrmPackage.Literals.SHAPE__FIRST_SEGMENT,
				OrmFactory.eINSTANCE.createSegment()));

		newChildDescriptors.add(createChildParameter(
				OrmPackage.Literals.SHAPE__SECOND_SEGMENT,
				OrmFactory.eINSTANCE.createSegment()));

		newChildDescriptors.add(createChildParameter(
				OrmPackage.Literals.SHAPE__MODEL,
		...
		newChildDescriptors.add(createChildParameter(
				OrmPackage.Literals.SHAPE__BOUNDARIES,
