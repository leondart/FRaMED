...
public class RelationItemProvider extends ModelElementItemProvider {
	...
	protected void addReferencedRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Relation_referencedRoles_feature",
						"_UI_Relation_type"),
				OrmPackage.Literals.RELATION__REFERENCED_ROLES, true, false,
				true, null, null, null));
	}
	...
	protected void addConnectionAnchorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Relation_connectionAnchor_feature",
						"_UI_Relation_type"),
				OrmPackage.Literals.RELATION__CONNECTION_ANCHOR, true, false,
				true, null, null, null));
	}
