...
public class ModelElementItemProvider extends ItemProviderAdapter implements
	...
	protected void addIncomingRelationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ModelElement_incomingRelations_feature",
	...
	protected void addOutgoingRelationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_ModelElement_outgoingRelations_feature",
						"_UI_ModelElement_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ModelElement"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case OrmPackage.MODEL_ELEMENT__NAME:
