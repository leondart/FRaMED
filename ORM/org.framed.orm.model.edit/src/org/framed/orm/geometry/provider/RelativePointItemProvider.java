...
public class RelativePointItemProvider extends ItemProviderAdapter implements
	...
	protected void addReferencePointsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelativePoint_referencePoints_feature",
						"_UI_RelativePoint_type"),
				GeometryPackage.Literals.RELATIVE_POINT__REFERENCE_POINTS,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(GeometryPackage.Literals.RELATIVE_POINT__DISTANCES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/RelativePoint"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				GeometryPackage.Literals.RELATIVE_POINT__DISTANCES,
