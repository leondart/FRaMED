 ...
 * <ul>
 *   <li>{@link orm.model.impl.ConstraintImpl#getRelationContainer <em>Relation Container</em>}</li>
 *   <li>{@link orm.model.impl.ConstraintImpl#getBendpoints <em>Bendpoints</em>}</li>
 *   <li>{@link orm.model.impl.ConstraintImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link orm.model.impl.ConstraintImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint {
	...
	public EList<Point> getBendpoints() {
		if (bendpoints == null) {
			bendpoints = new EDataTypeUniqueEList<Point>(Point.class, this, OrmPackage.CONSTRAINT__BENDPOINTS);
		}
		return bendpoints;
	}
