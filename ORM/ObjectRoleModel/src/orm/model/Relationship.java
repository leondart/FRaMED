 ...
 * <ul>
 *   <li>{@link orm.model.Relationship#getSecondParthood <em>Second Parthood</em>}</li>
 *   <li>{@link orm.model.Relationship#getSecondLower <em>Second Lower</em>}</li>
 *   <li>{@link orm.model.Relationship#getFirstLower <em>First Lower</em>}</li>
 *   <li>{@link orm.model.Relationship#getFirstUpper <em>First Upper</em>}</li>
 *   <li>{@link orm.model.Relationship#getSecondUpper <em>Second Upper</em>}</li>
 *   <li>{@link orm.model.Relationship#getFirstParthood <em>First Parthood</em>}</li>
 *   <li>{@link orm.model.Relationship#getSourceLabelValue <em>Source Label Value</em>}</li>
 *   <li>{@link orm.model.Relationship#getTargetLabelValue <em>Target Label Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see orm.model.OrmPackage#getRelationship()
 * @model
 * @generated
 */
public interface Relationship extends Relation {
	 ...
	 * The literals are from the enumeration {@link orm.model.Parthood}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see orm.model.OrmPackage#getRelationship_SecondParthood()
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getSecondParthood <em>Second Parthood</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see orm.model.OrmPackage#getRelationship_SecondLower()
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getSecondLower <em>Second Lower</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see orm.model.OrmPackage#getRelationship_FirstLower()
	 * @model default="0" required="true"
	 * @generated
	 */
	int getFirstLower();
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getFirstLower <em>First Lower</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see orm.model.OrmPackage#getRelationship_FirstUpper()
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getFirstUpper <em>First Upper</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see orm.model.OrmPackage#getRelationship_SecondUpper()
	 * @model default="1" required="true"
	 * @generated
	 */
	int getSecondUpper();
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getSecondUpper <em>Second Upper</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see orm.model.OrmPackage#getRelationship_FirstParthood()
	 * @model default="Unconstrained" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getFirstParthood <em>First Parthood</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see orm.model.OrmPackage#getRelationship_SourceLabelValue()
	 * @model default="*"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getSourceLabelValue <em>Source Label Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see orm.model.OrmPackage#getRelationship_TargetLabelValue()
	 * @model default="*"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link orm.model.Relationship#getTargetLabelValue <em>Target Label Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
